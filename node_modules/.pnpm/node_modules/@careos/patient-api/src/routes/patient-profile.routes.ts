...
patientProfileRouter.get('/profile', async (req: AuthenticatedPatientRequest, res) => {
  try {
...
patientProfileRouter.patch('/profile', async (req: AuthenticatedPatientRequest, res) => {
  try {
    const patientId = req.user?.patientId
