...
function Boot() {
  const restore = usePatientAuthStore((state) => state.restoreSession)
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/app" element={<PatientShell />}>
            ...
            <Route path="medical-basics" element={<Medical />} />
            ...
            <Route
              path="doctors/:hospitalDoctorId/slots"
              element={<DoctorSlots />}
            />
            <Route path="book/:hospitalDoctorId" element={<Book />} />
            ...
            <Route path="records/:encounterId" element={<RecordDetail />} />
